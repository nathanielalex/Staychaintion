...
export default function MarketplacePage() {
  ...
  useEffect(() => {
    ...
    let tempProducts = [...products].filter((product) => {
      ...
      const matchesCategory =
        activeTab === 'all' ||
        product.productType.toLowerCase() === activeTab.toLowerCase();
      const matchesPrice =
    ...
    tempProducts.sort((a, b) => {
      if (sortBy === 'priceLowToHigh') return getFinalPrice(a) - getFinalPrice(b);
      if (sortBy === 'priceHighToLow') return getFinalPrice(b) - getFinalPrice(a);
  ...
  }, [products, searchTerm, sortBy, activeTab, priceRange, selectedRating]);
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white">
      ...
      >
        ...
        <p className="text-center text-gray-600 mb-12 max-w-2xl mx-auto">
          Discover premium products for your home and lifestyle. From elegant
          furniture to smart home devices, find everything you need to enhance
          your living space.
        </p>
              ...
              <div>
                ...
                <div className="px-2">
                  ...
                  <div className="flex justify-between text-sm text-gray-500">
                    <span>{priceRange[0].toLocaleString('id-ID', {style: "currency", currency: "IDR"})}</span>
                    <span>{priceRange[1].toLocaleString('id-ID', {style: "currency", currency: "IDR"})}</span>
                  </div>
                </div>
              </div>
            ...
            <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 space-y-4 sm:space-y-0">
              ...
              >
                <TabsList className="w-full sm:w-auto justify-start">
                  <TabsTrigger value="all" className="text-white bg-black">
                    All Products
                  </TabsTrigger>
